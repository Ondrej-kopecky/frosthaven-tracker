...
const typeStyles = {
  ...
  info: {
    border: 'border-fh-primary/30',
    accent: 'bg-fh-primary',
    icon: 'text-fh-primary',
    text: 'text-gray-300',
...
<template>
  <div class="fixed bottom-4 right-4 z-[200] flex flex-col gap-2.5 pointer-events-none safe-area-bottom">
    <TransitionGroup name="toast">
      <div
        v-for="toast in toastStore.toasts"
        :key="toast.id"
        class="pointer-events-auto relative overflow-hidden rounded-xl border bg-fh-dark/95 backdrop-blur-md shadow-2xl shadow-black/50 min-w-[220px] max-w-[360px] cursor-pointer"
      ...
      >
        ...
        <div class="flex items-center gap-3 pl-4 pr-4 py-3">
          ...
          <button
            ...
            class="text-xs font-semibold text-fh-primary hover:text-fh-primary-light px-2 py-1 rounded-md bg-fh-primary/10 hover:bg-fh-primary/20 transition-colors shrink-0 ml-1"
