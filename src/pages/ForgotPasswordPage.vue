...
<template>
  <div class="max-w-sm mx-auto pt-16">
    <div class="text-center mb-10">
      ...
      <h1 class="font-display text-2xl font-bold text-fh-primary tracking-wide">Zapomenuté heslo</h1>
    ...
    <form v-else @submit.prevent="handleReset" class="space-y-4">
      <div>
        ...
        <input
          ...
          inputmode="numeric"
          maxlength="6"
          class="fh-input w-full text-center text-2xl tracking-[0.5em] font-mono"
          placeholder="000000"
        />
      </div>
      <div>
      ...
      <button
        type="button"
        class="w-full text-xs text-gray-500 hover:text-gray-300 transition-colors py-2"
        @click="handleForgot"
      >
        Odeslat kód znovu
      </button>
