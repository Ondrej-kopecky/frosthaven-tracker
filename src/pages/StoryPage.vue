  ...
  <div v-if="campaignStore.hasCampaign" class="max-w-3xl mx-auto">
    <div class="fh-page-header">
      ...
      <p class="text-sm text-gray-500 mt-1">
        {{ completedScenarios.length }} dokončených scénářů
      </p>
    </div>
    ...
    <div v-else class="relative">
      ...
      >
        <!-- Timeline dot -->
        <div
          class="absolute left-3 w-5 h-5 rounded-full border-2 border-fh-primary/60 bg-fh-dark flex items-center justify-center"
        >
          <div class="w-2 h-2 rounded-full bg-fh-primary" />
        </div>
